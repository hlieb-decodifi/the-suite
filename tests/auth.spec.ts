...
test.describe('Authentication', () => {
  test.describe('Client Authentication', () => {
    test('should allow client to sign up', async ({ page }) => {
      ...
      await expect(page.getByText(new RegExp(TEST_USERS.client.firstName))).toBeVisible();
  ...
  test.describe('Professional Authentication', () => {
    test('should allow professional to sign up', async ({ page }) => {
      ...
      // Verify successful signup
      await expect(page.getByRole('heading', { name: /dashboard/i })).toBeVisible();
      await expect(page.getByText(new RegExp(TEST_USERS.professional.firstName))).toBeVisible();
    ...
    test('should show professional-specific navigation items', async ({ page }) => {
      await signIn(page, TEST_USERS.professional);
