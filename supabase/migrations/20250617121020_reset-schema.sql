...
-- Remove SET search_path from all functions that had it
ALTER FUNCTION public.is_professional(uuid) RESET search_path;
ALTER FUNCTION public.is_client(uuid) RESET search_path;
ALTER FUNCTION public.get_service_limit(uuid) RESET search_path;
ALTER FUNCTION public.check_service_limit() RESET search_path;
ALTER FUNCTION public.update_service_limit(uuid, integer) RESET search_path;
ALTER FUNCTION public.handle_new_professional() RESET search_path;
ALTER FUNCTION public.handle_new_client() RESET search_path;
ALTER FUNCTION public.handle_new_user() RESET search_path;
ALTER FUNCTION public.check_portfolio_photo_limit() RESET search_path;
ALTER FUNCTION public.update_professional_subscription_status() RESET search_path;
ALTER FUNCTION public.check_professional_availability() RESET search_path;
ALTER FUNCTION public.handle_service_stripe_sync() RESET search_path;
ALTER FUNCTION public.handle_professional_profile_stripe_changes() RESET search_path;
ALTER FUNCTION public.handle_payment_method_stripe_changes() RESET search_path;
ALTER FUNCTION public.update_conversation_timestamp() RESET search_path;
ALTER FUNCTION public.handle_legal_document_versioning() RESET search_path;