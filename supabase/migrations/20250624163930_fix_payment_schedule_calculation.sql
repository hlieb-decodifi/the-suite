drop function if exists "public"."calculate_payment_schedule"(appointment_date date, appointment_time time without time zone);

set check_function_bodies = off;

CREATE OR REPLACE FUNCTION public.calculate_payment_schedule(appointment_date date, appointment_time time without time zone, duration_minutes integer DEFAULT 60)
