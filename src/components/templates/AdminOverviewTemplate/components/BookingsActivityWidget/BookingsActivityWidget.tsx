...
export function BookingsActivityWidget({ totalBookings, newBookings, bookingsPerDay, dateRangeLabel }: BookingsActivityWidgetProps) {
  ...
  return (
    <Card className="h-full">
      ...
      <CardContent>
        ...
        <Typography>
          New bookings <span className="text-yellow-500">{dateRangeLabel}</span>: {newBookings}
        </Typography>
        <div className="mt-6">
