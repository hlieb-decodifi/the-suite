...
export default function SubscriptionSectionClient({
  userData,
  plans,
  connectStatus,
  searchParams = {},
}: SubscriptionSectionClientProps) {
                ...
                <div className="border border-amber-200 bg-amber-50 rounded-lg p-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="space-y-3 flex-1">
                      ...
                      <form
                        action={handleStripeConnectRedirect.bind(
                          null,
                          userData.id,
                        )}
                      >
                    ...
                    <DialogContent>
                      <DialogHeader>
                        ...
                        <DialogDescription>
                          ...
                          You'll continue to have access to professional
                      ...
                      <DialogFooter>
                        ...
                        <form
                          action={handleCancelSubscriptionRedirect.bind(
                            null,
                            userData.id,
                          )}
                        >
          ...
          {plans.map((plan) => (
            ...
            >
              ...
              <CardFooter className="pt-6 bg-muted/10 border-t">
                <form
                  action={handleSubscriptionRedirect.bind(
                    null,
                    plan.id,
                    userData.id,
                  )}
      ...
      <Dialog open={showConnectModal} onOpenChange={setShowConnectModal}>
        <DialogContent>
          ...
          <DialogFooter>
            ...
            <form action={handleStripeConnectRedirect.bind(null, userData.id)}>
              <Button type="submit" onClick={() => setShowConnectModal(false)}>
