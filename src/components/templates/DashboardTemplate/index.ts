...
export { DashboardTemplateCard } from './components/DashboardTemplateCard/DashboardTemplateCard';
export { DashboardTemplateAppointmentsTable } from './components/DashboardTemplateAppointmentsTable/DashboardTemplateAppointmentsTable';
export { DashboardTemplateAppointmentsWidget } from './components/DashboardTemplateAppointmentsWidget/DashboardTemplateAppointmentsWidget';
