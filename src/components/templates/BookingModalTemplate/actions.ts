...
export async function createBooking(
  ...
  try {
    ...
    try {
      ...
      // Note: Admin client is used because booking_payments has RLS enabled but no insert policies
      // This is intentional - payment records should only be created by server-side code
      // after proper validation to prevent price manipulation and ensure data integrity
