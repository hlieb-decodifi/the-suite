...
export const locationFormSchema = z.object({
  address: z.string().min(1, 'Please select an address from the search dropdown'),
  ...
  {
    message: 'Address has been manually modified. Please select a new address from search to ensure accuracy.',
    path: ['googlePlaceId'],
  }
);
